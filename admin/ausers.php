...
if (isset($_GET['add'])){
	...
	$required=array('name','email','password','confirm','permissions','date');
	...
	if(!empty($errors)){
		  ...
		  $db->query("INSERT INTO users(full_name,email,password,permissions,edate) VALUES ('$name','$email','$hashed','$permissions','$date')");
    ...
    <form action="ausers.php?add=1" method="post">
...
<a href="ausers.php?add=1" id="add-product-btn" class="btn btn-success pull-right">Add new user</a>     
<br>
<table class="table table-bordered table-stripped table-condensed">
   <thead><th>Clear mac-Adress:</th><th>Delete user:</th><th>Name:</th><th>Username:</th><th>Join date:</th><th>Last login:</th><th>Expire date:</th><th>Permissions:</th><th>Mac address:</th></thead>
   <tbody>
